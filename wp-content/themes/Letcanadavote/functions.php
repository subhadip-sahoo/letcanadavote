...
function create_post_type() {
	register_post_type( 'acme_banner',
		array(
			'labels' => array(
				'name' => __( 'Banner' ),
 ...
 // HIDE THE EDITOR ON acme_gallery POST TYPES 
add_action('admin_head', 'hide_editor'); 
function hide_editor() { 
	remove_post_type_support( 'acme_banner', 'editor' ); 
}
add_filter( 'manage_edit-acme_banner_columns', 'my_edit_acme_banner_columns' ) ;
function my_edit_acme_banner_columns( $columns ) {

	$columns = array(
		'title' => __( 'Title' ),
		'banner_image' => __( 'Image' ),
		'date' => __( 'Date' )
	);

	return $columns;
}
add_action( 'manage_acme_banner_posts_custom_column', 'my_manage_acme_banner_columns', 10, 2 );

function my_manage_acme_banner_columns( $column, $post_id ) {
	global $post;
	...
	switch( $column ) {
		...
		case 'banner_image' :
			...
			echo ('<img src="'.$image.'" style="max-width:100px; max-height:70px;">');
...
add_action( 'init', 'init_CAvotes' );
function init_CAvotes() {
...
function my_login_logo_url_title() {
    return 'Letcanadavote';
}
add_filter( 'login_headertitle', 'my_login_logo_url_title' );

function change_footer_admin () {  
  echo 'Theme made by <a href="http://www.businessprodesigns.com">BPD</a>';  
}  
